...
# Longer names no longer fit the label at 80px (see templates/index.html, maxlength). Defined
# once here so the kiosk route and the REST API in api.py cut names at exactly the same point.
MAX_NAME = 15
